...
ApplicationMain.main = function() {
	...
	ApplicationMain.loaders.set("images/accion0.png",loader);
	ApplicationMain.total++;
	var loader1 = new flash.display.Loader();
	ApplicationMain.loaders.set("images/accion1.png",loader1);
	ApplicationMain.total++;
	var loader2 = new flash.display.Loader();
	ApplicationMain.loaders.set("images/accion10.png",loader2);
	ApplicationMain.total++;
	var loader3 = new flash.display.Loader();
	ApplicationMain.loaders.set("images/accion11.png",loader3);
	ApplicationMain.total++;
	var loader4 = new flash.display.Loader();
	ApplicationMain.loaders.set("images/accion12.png",loader4);
	ApplicationMain.total++;
	var loader5 = new flash.display.Loader();
	ApplicationMain.loaders.set("images/accion13.png",loader5);
	ApplicationMain.total++;
	var loader6 = new flash.display.Loader();
	ApplicationMain.loaders.set("images/accion14.png",loader6);
	ApplicationMain.total++;
	var loader7 = new flash.display.Loader();
	ApplicationMain.loaders.set("images/accion15.png",loader7);
	ApplicationMain.total++;
	var loader8 = new flash.display.Loader();
	ApplicationMain.loaders.set("images/accion16.png",loader8);
	ApplicationMain.total++;
	var loader9 = new flash.display.Loader();
	ApplicationMain.loaders.set("images/accion17.png",loader9);
	ApplicationMain.total++;
	var loader10 = new flash.display.Loader();
	ApplicationMain.loaders.set("images/accion18.png",loader10);
	ApplicationMain.total++;
	var loader11 = new flash.display.Loader();
	ApplicationMain.loaders.set("images/accion19.png",loader11);
	ApplicationMain.total++;
	var loader12 = new flash.display.Loader();
	ApplicationMain.loaders.set("images/accion2.png",loader12);
	ApplicationMain.total++;
	var loader13 = new flash.display.Loader();
	ApplicationMain.loaders.set("images/accion3.png",loader13);
	ApplicationMain.total++;
	var loader14 = new flash.display.Loader();
	ApplicationMain.loaders.set("images/accion4.png",loader14);
	ApplicationMain.total++;
	var loader15 = new flash.display.Loader();
	ApplicationMain.loaders.set("images/accion5.png",loader15);
	ApplicationMain.total++;
	var loader16 = new flash.display.Loader();
	ApplicationMain.loaders.set("images/accion6.png",loader16);
	ApplicationMain.total++;
	var loader17 = new flash.display.Loader();
	ApplicationMain.loaders.set("images/accion7.png",loader17);
	ApplicationMain.total++;
	var loader18 = new flash.display.Loader();
	ApplicationMain.loaders.set("images/accion8.png",loader18);
	ApplicationMain.total++;
	var loader19 = new flash.display.Loader();
	ApplicationMain.loaders.set("images/accion9.png",loader19);
	ApplicationMain.total++;
	var loader20 = new flash.display.Loader();
	ApplicationMain.loaders.set("images/botonDeshacer.png",loader20);
	ApplicationMain.total++;
	var loader21 = new flash.display.Loader();
	ApplicationMain.loaders.set("images/botonImagenes.png",loader21);
	ApplicationMain.total++;
	var loader22 = new flash.display.Loader();
	ApplicationMain.loaders.set("images/boton_jugar.png",loader22);
	ApplicationMain.total++;
	var loader23 = new flash.display.Loader();
	ApplicationMain.loaders.set("images/ejemplo.jpg",loader23);
	ApplicationMain.total++;
	var loader24 = new flash.display.Loader();
	ApplicationMain.loaders.set("images/fondo.jpg",loader24);
	ApplicationMain.total++;
	var loader25 = new flash.display.Loader();
	ApplicationMain.loaders.set("images/nodoCuadTree.png",loader25);
	ApplicationMain.total++;
	var loader26 = new flash.display.Loader();
	ApplicationMain.loaders.set("images/tablero.jpg",loader26);
	ApplicationMain.total++;
	...
	if(ApplicationMain.total == 0) ApplicationMain.begin(); else {
		...
		while( $it0.hasNext() ) {
			var path = $it0.next();
			var loader27 = ApplicationMain.loaders.get(path);
			loader27.contentLoaderInfo.addEventListener("complete",ApplicationMain.loader_onComplete);
			loader27.load(new flash.net.URLRequest(path));
		}
...
ApplicationMain.preloader_onComplete = function(event) {
	...
	} else Reflect.field(grepseed.ilo.Main,"main").apply(grepseed.ilo.Main,[]);
}
var flash = {}
flash.events = {}
...
var grepseed = {}
grepseed.ilo = {}
grepseed.ilo.Main = function() {
	flash.display.Sprite.call(this);
	this.addEventListener(flash.events.Event.ADDED_TO_STAGE,$bind(this,this.added));
};
$hxClasses["grepseed.ilo.Main"] = grepseed.ilo.Main;
grepseed.ilo.Main.__name__ = ["grepseed","ilo","Main"];
grepseed.ilo.Main.main = function() {
	...
	flash.Lib.get_current().get_stage().addEventListener(flash.events.KeyboardEvent.KEY_UP,grepseed.ilo.Main.eventoTeclaApretada);
	flash.Lib.get_current().addChild(new grepseed.ilo.Main());
}
grepseed.ilo.Main.eventoTeclaApretada = function(event) {
	if(event.keyCode == 27) {
	}
}
grepseed.ilo.Main.__super__ = flash.display.Sprite;
grepseed.ilo.Main.prototype = $extend(flash.display.Sprite.prototype,{
	resize: function(e) {
		if(!this._inited) this.init();
		var scaleX = this.get_stage().get_stageWidth() / grepseed.ilo.Main._ANCHO_PANTALLA;
		var scaleY = this.get_stage().get_stageHeight() / grepseed.ilo.Main._ALTO_PANTALLA;
		this.set_scaleX(this.set_scaleY(Math.min(scaleX,scaleY)));
		this.set_x((this.get_stage().get_stageWidth() - grepseed.ilo.Main._ANCHO_PANTALLA * this.get_scaleX()) / 2);
		this.set_y((this.get_stage().get_stageHeight() - grepseed.ilo.Main._ALTO_PANTALLA * this.get_scaleY()) / 2);
	}
	,gameLoop: function(e) {
		this._screenManager.updateLogic(haxe.Timer.stamp() - this._beginTime);
	}
	,init: function() {
		if(this._inited) return;
		this._inited = true;
		var clickManager = new grepseed.ilo.ManagerDeClicks();
		clickManager.setScroll(new grepseed.ilo.gameElements.scroll.ScrollNulo());
		this._beginTime = haxe.Timer.stamp();
		this._screenManager = new grepseed.ilo.screens.ScreenManager();
		this._screenManager.suscribeScreen("juego",new grepseed.ilo.screens.GamePlayScreen(this._screenManager,clickManager));
		this._screenManager.suscribeScreen("menu",new grepseed.ilo.screens.MenuScreen(this._screenManager,clickManager));
		this.addChild(this._screenManager);
		this.get_stage().addEventListener(flash.events.Event.ENTER_FRAME,$bind(this,this.gameLoop));
		this.get_stage().addEventListener(flash.events.MouseEvent.MOUSE_DOWN,$bind(clickManager,clickManager.clickAbajo));
		this.get_stage().addEventListener(flash.events.MouseEvent.MOUSE_UP,$bind(clickManager,clickManager.clickArriba));
		this.get_stage().addEventListener(flash.events.MouseEvent.MOUSE_MOVE,$bind(clickManager,clickManager.movida));
		this.resize(null);
	}
	,added: function(e) {
	...
	,__class__: grepseed.ilo.Main
});
var DocumentClass = function() {
	grepseed.ilo.Main.call(this);
};
$hxClasses["DocumentClass"] = DocumentClass;
DocumentClass.__name__ = ["DocumentClass"];
DocumentClass.__super__ = grepseed.ilo.Main;
DocumentClass.prototype = $extend(grepseed.ilo.Main.prototype,{
	get_stage: function() {
...
grepseed.ilo.ManagerDeClicks = function() {
	this._receptores = new Array();
	this._ultimaPosicion = new flash.geom.Point(0,0);
};
$hxClasses["grepseed.ilo.ManagerDeClicks"] = grepseed.ilo.ManagerDeClicks;
grepseed.ilo.ManagerDeClicks.__name__ = ["grepseed","ilo","ManagerDeClicks"];
grepseed.ilo.ManagerDeClicks.prototype = {
	movida: function(e) {
		if(this._clickeando) {
			this._scroll.mover(e.localX - this._ultimaPosicion.x,e.localY - this._ultimaPosicion.y);
			this.setUltimaPosicion(e.localX,e.localY);
			if(this._botonClickeado != null) {
				if(this._botonClickeado.checkClick()) this._botonClickeado.apretar(); else this._botonClickeado.soltar();
			}
		}
	}
	,clickArriba: function(e) {
		if(this._botonClickeado != null && this._botonClickeado.checkClick()) this._botonClickeado.click();
		this._scroll.moverHastaElAncla();
		this._botonClickeado = null;
		this._clickeando = false;
	}
	,clickAbajo: function(e) {
		var clicked = false;
		var i = this._receptores.length;
		this.setUltimaPosicion(e.localX,e.localY);
		this._clickeando = true;
		while(i > 0 && !clicked) {
			this._botonClickeado = this._receptores[i - 1];
			clicked = this._botonClickeado.checkClick();
			i--;
		}
		if(clicked) this._botonClickeado.apretar(); else this._botonClickeado = null;
	}
	,agregar: function(receptor) {
		this._receptores.push(receptor);
	}
	,setScroll: function(scroll) {
		this._scroll = scroll;
	}
	,setUltimaPosicion: function(posX,posY) {
		this._ultimaPosicion.x = posX;
		this._ultimaPosicion.y = posY;
	}
	,__class__: grepseed.ilo.ManagerDeClicks
}
grepseed.ilo.ManagerDeNodos = function(clickManager,imagenPreview) {
	this._usos = 0;
	this._nodos = new Array();
	this._destinosDeAccion = new Array();
	this._clickManager = clickManager;
	this._imagenPreview = imagenPreview;
};
$hxClasses["grepseed.ilo.ManagerDeNodos"] = grepseed.ilo.ManagerDeNodos;
grepseed.ilo.ManagerDeNodos.__name__ = ["grepseed","ilo","ManagerDeNodos"];
grepseed.ilo.ManagerDeNodos.prototype = {
	mezclar: function(cant,botonera) {
		var _g1 = this;
		var _g = 0;
		while(_g < cant) {
			var i = _g++;
			motion.Actuate.timer(grepseed.ilo.ManagerDeNodos._TIEMPO_DE_ANIMACION * 1.5 * i).onComplete(function() {
				botonera.clickRandom();
				_g1._nodos[Math.floor(Math.random() * _g1._nodos.length)].click();
			});
		}
	}
	...
	,intercambiarHojas: function(origenes,ids) {
		if(this.isBloqueado()) return;
		this._usos++;
		var posOrigen = new Array();
		var posDestino = new Array();
		var _g = 0;
		while(_g < 4) {
			var id = _g++;
		...
		var aux;
		var _g = 0, _g1 = this._destinosDeAccion;
		while(_g < _g1.length) {
			var destino = _g1[_g];
			++_g;
		...
		this.animar(origenes,ids,posOrigen,posDestino);
		this._usos--;
	}
	,agregar: function(nodo) {
		this._nodos.push(nodo);
		this._clickManager.agregar(nodo);
	}
	,setAccion: function(id,destinos) {
		this._imagenPreview.setImagen("images/accion" + id + ".png");
		this._destinosDeAccion = destinos;
	}
	,animacionTerminada: function() {
		this._usos--;
		if(this._usos == 0) {
			var _g = 0, _g1 = this._nodos;
			while(_g < _g1.length) {
				var nodo = _g1[_g];
				++_g;
				nodo.controlarDisponibilidad(grepseed.ilo.ManagerDeNodos._TIEMPO_DE_ANIMACION);
			}
		}
	}
	,animar: function(padres,ids,posOrigen,posDestino) {
		var objetivo;
		var posVieja;
		this._usos += 4;
		var _g = 0;
		while(_g < 4) {
			...
			posVieja = new flash.geom.Point(objetivo.get_x(),objetivo.get_y());
			var _g1 = objetivo;
			_g1.set_x(_g1.get_x() + (posDestino[id].x - posOrigen[id].x));
			var _g1 = objetivo;
			_g1.set_y(_g1.get_y() + (posDestino[id].y - posOrigen[id].y));
			motion.Actuate.tween(objetivo,grepseed.ilo.ManagerDeNodos._TIEMPO_DE_ANIMACION,{ x : posVieja.x, y : posVieja.y},false).ease(motion.easing.Elastic.get_easeIn()).onComplete($bind(this,this.animacionTerminada));
		}
	}
	,__class__: grepseed.ilo.ManagerDeNodos
}
grepseed.ilo.gameElements = {}
grepseed.ilo.gameElements.GameElement = function() {
	flash.display.Sprite.call(this);
	this._logicalChild = new Array();
};
$hxClasses["grepseed.ilo.gameElements.GameElement"] = grepseed.ilo.gameElements.GameElement;
grepseed.ilo.gameElements.GameElement.__name__ = ["grepseed","ilo","gameElements","GameElement"];
grepseed.ilo.gameElements.GameElement.__super__ = flash.display.Sprite;
grepseed.ilo.gameElements.GameElement.prototype = $extend(flash.display.Sprite.prototype,{
	removeLogicalChild: function(child) {
		HxOverrides.remove(this._logicalChild,child);
	}
	,agregarHijoCompleto: function(hijo) {
		this.addChild(hijo);
		this.addLogicalChild(hijo);
	}
	,borrarHijoCompleto: function(hijo) {
		this.removeChild(hijo);
		this.removeLogicalChild(hijo);
	}
	,addLogicalChild: function(child) {
		this.removeLogicalChild(child);
		this._logicalChild.push(child);
	}
	,getHeight: function() {
	...
	,isTouched: function() {
		return 0 < this.get_mouseX() && 0 < this.get_mouseY() && this.getWidth() > this.get_mouseX() && this.getHeight() > this.get_mouseY();
	}
	,setSize: function(height) {
		this.set_scaleX(this.set_scaleY(1));
		var proporcion = height / this.get_height();
		this.set_scaleX(this.set_scaleY(proporcion));
	}
	,updateLogic: function(time) {
		var _g = 0, _g1 = this._logicalChild;
		while(_g < _g1.length) {
			var hijo = _g1[_g];
			++_g;
	...
	,__class__: grepseed.ilo.gameElements.GameElement
});
grepseed.ilo.gameElements.Image = function(path) {
	grepseed.ilo.gameElements.GameElement.call(this);
	this.setImagen(path);
};
$hxClasses["grepseed.ilo.gameElements.Image"] = grepseed.ilo.gameElements.Image;
grepseed.ilo.gameElements.Image.__name__ = ["grepseed","ilo","gameElements","Image"];
grepseed.ilo.gameElements.Image.__super__ = grepseed.ilo.gameElements.GameElement;
grepseed.ilo.gameElements.Image.prototype = $extend(grepseed.ilo.gameElements.GameElement.prototype,{
	setImagen: function(path) {
		if(this.nmeChildren.length > 0) this.removeChildAt(0);
		this.addChild(new flash.display.Bitmap(openfl.Assets.getBitmapData(path)));
	}
	,__class__: grepseed.ilo.gameElements.Image
});
grepseed.ilo.gameElements.Boton = function(path,accion) {
	grepseed.ilo.gameElements.Image.call(this,path);
	this._accion = accion;
};
$hxClasses["grepseed.ilo.gameElements.Boton"] = grepseed.ilo.gameElements.Boton;
grepseed.ilo.gameElements.Boton.__name__ = ["grepseed","ilo","gameElements","Boton"];
grepseed.ilo.gameElements.Boton.__super__ = grepseed.ilo.gameElements.Image;
grepseed.ilo.gameElements.Boton.prototype = $extend(grepseed.ilo.gameElements.Image.prototype,{
	click: function() {
		this._accion.hacer();
		this.soltar();
	}
	...
	,checkClick: function() {
		if(this.get_visible() && this.isTouched()) return true;
		return false;
	}
	,__class__: grepseed.ilo.gameElements.Boton
});
grepseed.ilo.gameElements.boton = {}
grepseed.ilo.gameElements.boton.AccionDeBoton = function() { }
$hxClasses["grepseed.ilo.gameElements.boton.AccionDeBoton"] = grepseed.ilo.gameElements.boton.AccionDeBoton;
grepseed.ilo.gameElements.boton.AccionDeBoton.__name__ = ["grepseed","ilo","gameElements","boton","AccionDeBoton"];
grepseed.ilo.gameElements.boton.AccionDeBoton.prototype = {
	__class__: grepseed.ilo.gameElements.boton.AccionDeBoton
}
grepseed.ilo.gameElements.boton.AccionAgregarMemento = function(boton,managerDeMementos) {
	this._boton = boton;
	this._managerDeMementos = managerDeMementos;
};
$hxClasses["grepseed.ilo.gameElements.boton.AccionAgregarMemento"] = grepseed.ilo.gameElements.boton.AccionAgregarMemento;
grepseed.ilo.gameElements.boton.AccionAgregarMemento.__name__ = ["grepseed","ilo","gameElements","boton","AccionAgregarMemento"];
grepseed.ilo.gameElements.boton.AccionAgregarMemento.__interfaces__ = [grepseed.ilo.gameElements.boton.AccionDeBoton];
grepseed.ilo.gameElements.boton.AccionAgregarMemento.prototype = {
	hacer: function() {
		this._managerDeMementos.hacer(this._boton);
	}
	,__class__: grepseed.ilo.gameElements.boton.AccionAgregarMemento
}
grepseed.ilo.gameElements.boton.AccionAnd = function(acciones) {
	this._acciones = acciones;
};
$hxClasses["grepseed.ilo.gameElements.boton.AccionAnd"] = grepseed.ilo.gameElements.boton.AccionAnd;
grepseed.ilo.gameElements.boton.AccionAnd.__name__ = ["grepseed","ilo","gameElements","boton","AccionAnd"];
grepseed.ilo.gameElements.boton.AccionAnd.__interfaces__ = [grepseed.ilo.gameElements.boton.AccionDeBoton];
grepseed.ilo.gameElements.boton.AccionAnd.prototype = {
	hacer: function() {
		var _g = 0, _g1 = this._acciones;
		while(_g < _g1.length) {
			var a = _g1[_g];
			++_g;
			a.hacer();
	...
	,__class__: grepseed.ilo.gameElements.boton.AccionAnd
}
grepseed.ilo.gameElements.boton.AccionCambiarAccionNodo = function(id,managerDeNodos,managerDeMementos) {
	this._id = id;
	this._managerDeNodos = managerDeNodos;
	this._managerDeMementos = managerDeMementos;
};
$hxClasses["grepseed.ilo.gameElements.boton.AccionCambiarAccionNodo"] = grepseed.ilo.gameElements.boton.AccionCambiarAccionNodo;
grepseed.ilo.gameElements.boton.AccionCambiarAccionNodo.__name__ = ["grepseed","ilo","gameElements","boton","AccionCambiarAccionNodo"];
grepseed.ilo.gameElements.boton.AccionCambiarAccionNodo.__interfaces__ = [grepseed.ilo.gameElements.boton.AccionDeBoton];
grepseed.ilo.gameElements.boton.AccionCambiarAccionNodo.GetCantidadDeRotaciones = function() {
	return grepseed.ilo.gameElements.boton.AccionCambiarAccionNodo._ROTACIONES.length;
}
grepseed.ilo.gameElements.boton.AccionCambiarAccionNodo.prototype = {
	deshacer: function() {
		var id = grepseed.ilo.gameElements.boton.AccionCambiarAccionNodo._INVERSAS[this._id];
		this._managerDeNodos.setAccion(id,grepseed.ilo.gameElements.boton.AccionCambiarAccionNodo._ROTACIONES[id]);
	}
	,hacer: function() {
		this._managerDeNodos.setAccion(this._id,grepseed.ilo.gameElements.boton.AccionCambiarAccionNodo._ROTACIONES[this._id]);
		this._managerDeMementos.setProximaAccion(this);
	}
	,__class__: grepseed.ilo.gameElements.boton.AccionCambiarAccionNodo
}
grepseed.ilo.gameElements.boton.AccionCambiarPantalla = function(scene,screenManager) {
	this._nextScene = scene;
	this._screenManager = screenManager;
};
$hxClasses["grepseed.ilo.gameElements.boton.AccionCambiarPantalla"] = grepseed.ilo.gameElements.boton.AccionCambiarPantalla;
grepseed.ilo.gameElements.boton.AccionCambiarPantalla.__name__ = ["grepseed","ilo","gameElements","boton","AccionCambiarPantalla"];
grepseed.ilo.gameElements.boton.AccionCambiarPantalla.__interfaces__ = [grepseed.ilo.gameElements.boton.AccionDeBoton];
grepseed.ilo.gameElements.boton.AccionCambiarPantalla.prototype = {
	hacer: function() {
		this._screenManager.switchScene(this._nextScene);
	}
	,__class__: grepseed.ilo.gameElements.boton.AccionCambiarPantalla
}
grepseed.ilo.gameElements.boton.AccionDeshacer = function(managerDeMementos) {
	this._managerDeMementos = managerDeMementos;
};
$hxClasses["grepseed.ilo.gameElements.boton.AccionDeshacer"] = grepseed.ilo.gameElements.boton.AccionDeshacer;
grepseed.ilo.gameElements.boton.AccionDeshacer.__name__ = ["grepseed","ilo","gameElements","boton","AccionDeshacer"];
grepseed.ilo.gameElements.boton.AccionDeshacer.__interfaces__ = [grepseed.ilo.gameElements.boton.AccionDeBoton];
grepseed.ilo.gameElements.boton.AccionDeshacer.prototype = {
	hacer: function() {
		this._managerDeMementos.deshacer();
	}
	,__class__: grepseed.ilo.gameElements.boton.AccionDeshacer
}
grepseed.ilo.gameElements.boton.AccionNodo = function(finders,managerDeNodos) {
	this._finders = finders;
	this._managerDeNodos = managerDeNodos;
};
$hxClasses["grepseed.ilo.gameElements.boton.AccionNodo"] = grepseed.ilo.gameElements.boton.AccionNodo;
grepseed.ilo.gameElements.boton.AccionNodo.__name__ = ["grepseed","ilo","gameElements","boton","AccionNodo"];
grepseed.ilo.gameElements.boton.AccionNodo.__interfaces__ = [grepseed.ilo.gameElements.boton.AccionDeBoton];
grepseed.ilo.gameElements.boton.AccionNodo.prototype = {
	hacer: function() {
		if(!this._managerDeNodos.isBloqueado()) {
			...
			while(_g < 4) {
				var id = _g++;
				nivel = Math.floor(Math.min(nivel,this._finders[id].getCT().getNivelDeUnion(3 - id)));
			}
			var _g = 0;
			while(_g < 4) {
				var id = _g++;
				if(nivel == 0) {
					ids.push(this._finders[id].getId());
					origenes.push(this._finders[id].getCTPadre());
				} else {
					ids.push(3 - id);
					origenes.push(this._finders[id].getCT().getPadrePorNivel(3 - id,nivel));
				}
			}
			this._managerDeNodos.intercambiarHojas(origenes,ids);
		}
	}
	,__class__: grepseed.ilo.gameElements.boton.AccionNodo
}
grepseed.ilo.gameElements.boton.AccionNula = function() {
};
$hxClasses["grepseed.ilo.gameElements.boton.AccionNula"] = grepseed.ilo.gameElements.boton.AccionNula;
grepseed.ilo.gameElements.boton.AccionNula.__name__ = ["grepseed","ilo","gameElements","boton","AccionNula"];
grepseed.ilo.gameElements.boton.AccionNula.__interfaces__ = [grepseed.ilo.gameElements.boton.AccionDeBoton];
grepseed.ilo.gameElements.boton.AccionNula.prototype = {
	hacer: function() {
	}
	,__class__: grepseed.ilo.gameElements.boton.AccionNula
}
grepseed.ilo.gameElements.cuadtree = {}
grepseed.ilo.gameElements.cuadtree.CuadTree = function(posicion,finder) {
	grepseed.ilo.gameElements.GameElement.call(this);
	if(finder == null) finder = new grepseed.ilo.gameElements.cuadtree.finder.FinderRaiz(this);
	this._finder = finder;
	this.set_x(posicion.x);
	this.set_y(posicion.y);
};
$hxClasses["grepseed.ilo.gameElements.cuadtree.CuadTree"] = grepseed.ilo.gameElements.cuadtree.CuadTree;
grepseed.ilo.gameElements.cuadtree.CuadTree.__name__ = ["grepseed","ilo","gameElements","cuadtree","CuadTree"];
grepseed.ilo.gameElements.cuadtree.CuadTree.__super__ = grepseed.ilo.gameElements.GameElement;
grepseed.ilo.gameElements.cuadtree.CuadTree.prototype = $extend(grepseed.ilo.gameElements.GameElement.prototype,{
	intercambiar: function(idOrigen,destino,idDestino) {
		var p0 = this;
		var p1 = destino;
		var h0 = p0.getHijo(idOrigen);
		var h1 = p1.getHijo(idDestino);
		h0.swapPosiciones(h1);
		p0.swapHijos(p1,h0,h1);
		h0.swapFinders(h1);
	}
	,getPadrePorNivel: function(id,nivel) {
		if(nivel == 1) return this;
		return this.getHijo(id).getPadrePorNivel(id,nivel - 1);
	}
	,getNivelDeUnion: function(id) {
		if(this.isHoja()) return 0;
		return this.getHijo(id).getNivelDeUnion(id) + 1;
	}
	,getFinder: function() {
		return this._finder;
	}
	,crearNodoVertical: function(vecino,raiz,managerDeNodos,managerDeMementos) {
	}
	,crearNodoHorizontal: function(vecino,raiz,managerDeNodos,managerDeMementos) {
	}
	,crearNodos: function(raiz,managerDeNodos,managerDeMementos) {
	}
	,isHoja: function() {
		return true;
	}
	...
	,setHijo: function(id,nuevo) {
	}
	,swapFinders: function(vecino) {
		var f = this._finder;
		this._finder = vecino._finder;
		vecino._finder = f;
		if(this.getHijo(0) != null) {
			var _g = 0;
			while(_g < 4) {
				var id = _g++;
				this.getHijo(id).swapFinders(vecino.getHijo(id));
			}
		}
	}
	,swapHijos: function(vecino,hijoPropio,hijoAjeno) {
		this.removeChild(hijoPropio);
		vecino.removeChild(hijoAjeno);
		this.addChild(hijoAjeno);
		vecino.addChild(hijoPropio);
	}
	,swapPosiciones: function(vecino) {
		var pos = new flash.geom.Point(this.get_x(),this.get_y());
		this.set_x(vecino.get_x());
		this.set_y(vecino.get_y());
		vecino.set_x(pos.x);
		vecino.set_y(pos.y);
	}
	,__class__: grepseed.ilo.gameElements.cuadtree.CuadTree
});
grepseed.ilo.gameElements.cuadtree.CTHoja = function(id,finder,posicion,fuente) {
	grepseed.ilo.gameElements.cuadtree.CuadTree.call(this,posicion,finder);
	fuente.dibujar(this.get_graphics(),id);
	this._idDibujo = id;
};
$hxClasses["grepseed.ilo.gameElements.cuadtree.CTHoja"] = grepseed.ilo.gameElements.cuadtree.CTHoja;
grepseed.ilo.gameElements.cuadtree.CTHoja.__name__ = ["grepseed","ilo","gameElements","cuadtree","CTHoja"];
grepseed.ilo.gameElements.cuadtree.CTHoja.__super__ = grepseed.ilo.gameElements.cuadtree.CuadTree;
grepseed.ilo.gameElements.cuadtree.CTHoja.prototype = $extend(grepseed.ilo.gameElements.cuadtree.CuadTree.prototype,{
	crearNodoVertical: function(vecino,raiz,managerDeNodos,managerDeMementos) {
	}
	,crearNodoHorizontal: function(vecino,raiz,managerDeNodos,managerDeMementos) {
	}
	...
	,__class__: grepseed.ilo.gameElements.cuadtree.CTHoja
});
grepseed.ilo.gameElements.cuadtree.CTRama = function(primerId,finder,cantHojas,posicion,fuente) {
	grepseed.ilo.gameElements.cuadtree.CuadTree.call(this,posicion,finder);
	this._hijos = new Array();
	this.crearHijos(primerId,Math.round(cantHojas / 4),fuente);
};
$hxClasses["grepseed.ilo.gameElements.cuadtree.CTRama"] = grepseed.ilo.gameElements.cuadtree.CTRama;
grepseed.ilo.gameElements.cuadtree.CTRama.__name__ = ["grepseed","ilo","gameElements","cuadtree","CTRama"];
grepseed.ilo.gameElements.cuadtree.CTRama.__super__ = grepseed.ilo.gameElements.cuadtree.CuadTree;
grepseed.ilo.gameElements.cuadtree.CTRama.prototype = $extend(grepseed.ilo.gameElements.cuadtree.CuadTree.prototype,{
	intercambiar: function(idOrigen,destino,idDestino) {
		grepseed.ilo.gameElements.cuadtree.CuadTree.prototype.intercambiar.call(this,idOrigen,destino,idDestino);
		var h = this.getHijo(idOrigen);
		this.setHijo(idOrigen,destino.getHijo(idDestino));
		destino.setHijo(idDestino,h);
	}
	,crearNodoVertical: function(vecino,raiz,managerDeNodos,managerDeMementos) {
		var finders = new Array();
		finders.push(this.getHijo(2).getFinder());
		finders.push(this.getHijo(3).getFinder());
		finders.push(vecino.getHijo(0).getFinder());
		finders.push(vecino.getHijo(1).getFinder());
		var nodo = new grepseed.ilo.gameElements.cuadtree.nodo.NodoExtra(finders,managerDeNodos,managerDeMementos);
		managerDeNodos.agregar(nodo);
		raiz.addChild(nodo);
		this._hijos[2].crearNodoVertical(vecino.getHijo(0),raiz,managerDeNodos,managerDeMementos);
		this._hijos[3].crearNodoVertical(vecino.getHijo(1),raiz,managerDeNodos,managerDeMementos);
	}
	,crearNodoHorizontal: function(vecino,raiz,managerDeNodos,managerDeMementos) {
		var finders = new Array();
		finders.push(this.getHijo(1).getFinder());
		finders.push(vecino.getHijo(0).getFinder());
		finders.push(this.getHijo(3).getFinder());
		...
		managerDeNodos.agregar(nodo);
		raiz.addChild(nodo);
		this._hijos[1].crearNodoHorizontal(vecino.getHijo(0),raiz,managerDeNodos,managerDeMementos);
		this._hijos[3].crearNodoHorizontal(vecino.getHijo(2),raiz,managerDeNodos,managerDeMementos);
	}
	,crearNodos: function(raiz,managerDeNodos,managerDeMementos) {
		var finders = new Array();
		var _g = 0;
		while(_g < 4) {
			var id = _g++;
			finders.push(this.getHijo(id).getFinder());
		}
		var nodo = new grepseed.ilo.gameElements.cuadtree.nodo.NodoCuadTree(finders,managerDeNodos,managerDeMementos);
		managerDeNodos.agregar(nodo);
		raiz.addChild(nodo);
		var _g = 0;
		while(_g < 4) {
			var id = _g++;
			this._hijos[id].crearNodos(raiz,managerDeNodos,managerDeMementos);
		}
		this._hijos[0].crearNodoHorizontal(this._hijos[1],raiz,managerDeNodos,managerDeMementos);
		this._hijos[2].crearNodoHorizontal(this._hijos[3],raiz,managerDeNodos,managerDeMementos);
		this._hijos[0].crearNodoVertical(this._hijos[2],raiz,managerDeNodos,managerDeMementos);
		this._hijos[1].crearNodoVertical(this._hijos[3],raiz,managerDeNodos,managerDeMementos);
	}
	,isHoja: function() {
		var dif = this.getHijo(1).getId() - this.getHijo(0).getId();
		return this.getHijo(0).isHoja() && this.getHijo(1).isHoja() && this.getHijo(2).isHoja() && this.getHijo(3).isHoja() && this.getHijo(0).getId() / dif % 4 == 0 && this.getHijo(2).getId() - this.getHijo(1).getId() == dif && this.getHijo(3).getId() - this.getHijo(2).getId() == dif;
	}
	,getId: function() {
		return this.getHijo(0).getId();
	}
	,getHijo: function(id) {
		return this._hijos[id];
	}
	,setHijo: function(id,nuevo) {
		this._hijos[id] = nuevo;
	}
	,crearHijos: function(primerId,cantHojas,fuente) {
		var generador;
		if(cantHojas == 1) generador = new grepseed.ilo.gameElements.cuadtree.generador.GeneradorDeHoja(); else generador = new grepseed.ilo.gameElements.cuadtree.generador.GeneradorDeRama();
		var _g = 0;
		while(_g < 4) {
			var id = _g++;
			var aux = generador.generar(id * cantHojas + primerId,cantHojas,new flash.geom.Point(id % 2 * fuente.getAncho() * Math.sqrt(cantHojas),Math.floor(id / 2) * fuente.getAlto() * Math.sqrt(cantHojas)),new grepseed.ilo.gameElements.cuadtree.finder.FinderFx(this.getFinder(),id),fuente);
			this._hijos.push(aux);
			this.addChild(aux);
		}
	}
	,__class__: grepseed.ilo.gameElements.cuadtree.CTRama
});
grepseed.ilo.gameElements.cuadtree.FuenteCT = function(path,columnas,filas) {
	var imagen = openfl.Assets.getBitmapData(path);
	this._ancho = (imagen._nmeTextureBuffer != null?imagen._nmeTextureBuffer.width:0) / columnas;
	this._alto = (imagen._nmeTextureBuffer != null?imagen._nmeTextureBuffer.height:0) / filas;
	this._tileSheet = new openfl.display.Tilesheet(imagen);
	this.inicializarTileSheet(0,0,imagen._nmeTextureBuffer != null?imagen._nmeTextureBuffer.width:0);
};
$hxClasses["grepseed.ilo.gameElements.cuadtree.FuenteCT"] = grepseed.ilo.gameElements.cuadtree.FuenteCT;
grepseed.ilo.gameElements.cuadtree.FuenteCT.__name__ = ["grepseed","ilo","gameElements","cuadtree","FuenteCT"];
grepseed.ilo.gameElements.cuadtree.FuenteCT.prototype = {
	dibujar: function(graficos,id) {
		this._tileSheet.drawTiles(graficos,[0,0,id]);
	}
	,getAncho: function() {
		return this._ancho;
	}
	...
	,inicializarTileSheet: function(inicioX,inicioY,tamanio) {
		if(this._ancho == tamanio) this._tileSheet.addTileRect(new flash.geom.Rectangle(inicioX,inicioY,this._ancho,this._alto)); else {
			tamanio /= 2;
			this.inicializarTileSheet(inicioX,inicioY,tamanio);
			this.inicializarTileSheet(inicioX + tamanio,inicioY,tamanio);
			this.inicializarTileSheet(inicioX,inicioY + tamanio * this._alto / this._ancho,tamanio);
			this.inicializarTileSheet(inicioX + tamanio,inicioY + tamanio * this._alto / this._ancho,tamanio);
		}
	}
	,__class__: grepseed.ilo.gameElements.cuadtree.FuenteCT
}
grepseed.ilo.gameElements.cuadtree.finder = {}
grepseed.ilo.gameElements.cuadtree.finder.Finder = function() { }
$hxClasses["grepseed.ilo.gameElements.cuadtree.finder.Finder"] = grepseed.ilo.gameElements.cuadtree.finder.Finder;
grepseed.ilo.gameElements.cuadtree.finder.Finder.__name__ = ["grepseed","ilo","gameElements","cuadtree","finder","Finder"];
grepseed.ilo.gameElements.cuadtree.finder.Finder.prototype = {
	__class__: grepseed.ilo.gameElements.cuadtree.finder.Finder
}
grepseed.ilo.gameElements.cuadtree.finder.FinderFx = function(finderPadre,id) {
	this._finderPadre = finderPadre;
	this._id = id;
};
$hxClasses["grepseed.ilo.gameElements.cuadtree.finder.FinderFx"] = grepseed.ilo.gameElements.cuadtree.finder.FinderFx;
grepseed.ilo.gameElements.cuadtree.finder.FinderFx.__name__ = ["grepseed","ilo","gameElements","cuadtree","finder","FinderFx"];
grepseed.ilo.gameElements.cuadtree.finder.FinderFx.__interfaces__ = [grepseed.ilo.gameElements.cuadtree.finder.Finder];
grepseed.ilo.gameElements.cuadtree.finder.FinderFx.prototype = {
	getId: function() {
		return this._id;
	}
	,getPosicionAbsoluta: function() {
		var resultado = this._finderPadre.getPosicionAbsoluta();
		var ct = this.getCT();
		resultado.x += ct.get_x();
		resultado.y += ct.get_y();
		return resultado;
	}
	,getHoja: function() {
		if(this.getCTPadre().isHoja()) return this._finderPadre.getHoja();
		return this.getCT();
	}
	,getCTPadre: function() {
		return this._finderPadre.getCT();
	}
	,getCT: function() {
		return this.getCTPadre().getHijo(this._id);
	}
	,__class__: grepseed.ilo.gameElements.cuadtree.finder.FinderFx
}
grepseed.ilo.gameElements.cuadtree.finder.FinderRaiz = function(ct) {
	this._ct = ct;
};
$hxClasses["grepseed.ilo.gameElements.cuadtree.finder.FinderRaiz"] = grepseed.ilo.gameElements.cuadtree.finder.FinderRaiz;
grepseed.ilo.gameElements.cuadtree.finder.FinderRaiz.__name__ = ["grepseed","ilo","gameElements","cuadtree","finder","FinderRaiz"];
grepseed.ilo.gameElements.cuadtree.finder.FinderRaiz.__interfaces__ = [grepseed.ilo.gameElements.cuadtree.finder.Finder];
grepseed.ilo.gameElements.cuadtree.finder.FinderRaiz.prototype = {
	getId: function() {
		return -1;
	}
	,getPosicionAbsoluta: function() {
		return new flash.geom.Point(this._ct.get_x(),this._ct.get_y());
	}
	,getHoja: function() {
		return this.getCT();
	}
	...
	,__class__: grepseed.ilo.gameElements.cuadtree.finder.FinderRaiz
}
grepseed.ilo.gameElements.cuadtree.generador = {}
grepseed.ilo.gameElements.cuadtree.generador.GeneradorDeCuadTree = function() { }
$hxClasses["grepseed.ilo.gameElements.cuadtree.generador.GeneradorDeCuadTree"] = grepseed.ilo.gameElements.cuadtree.generador.GeneradorDeCuadTree;
grepseed.ilo.gameElements.cuadtree.generador.GeneradorDeCuadTree.__name__ = ["grepseed","ilo","gameElements","cuadtree","generador","GeneradorDeCuadTree"];
grepseed.ilo.gameElements.cuadtree.generador.GeneradorDeCuadTree.prototype = {
	__class__: grepseed.ilo.gameElements.cuadtree.generador.GeneradorDeCuadTree
}
grepseed.ilo.gameElements.cuadtree.generador.GeneradorDeHoja = function() {
};
$hxClasses["grepseed.ilo.gameElements.cuadtree.generador.GeneradorDeHoja"] = grepseed.ilo.gameElements.cuadtree.generador.GeneradorDeHoja;
grepseed.ilo.gameElements.cuadtree.generador.GeneradorDeHoja.__name__ = ["grepseed","ilo","gameElements","cuadtree","generador","GeneradorDeHoja"];
grepseed.ilo.gameElements.cuadtree.generador.GeneradorDeHoja.__interfaces__ = [grepseed.ilo.gameElements.cuadtree.generador.GeneradorDeCuadTree];
grepseed.ilo.gameElements.cuadtree.generador.GeneradorDeHoja.prototype = {
	generar: function(id,cantHojas,posicion,finder,fuente) {
		return new grepseed.ilo.gameElements.cuadtree.CTHoja(id,finder,posicion,fuente);
	}
	,__class__: grepseed.ilo.gameElements.cuadtree.generador.GeneradorDeHoja
}
grepseed.ilo.gameElements.cuadtree.generador.GeneradorDeRama = function() {
};
$hxClasses["grepseed.ilo.gameElements.cuadtree.generador.GeneradorDeRama"] = grepseed.ilo.gameElements.cuadtree.generador.GeneradorDeRama;
grepseed.ilo.gameElements.cuadtree.generador.GeneradorDeRama.__name__ = ["grepseed","ilo","gameElements","cuadtree","generador","GeneradorDeRama"];
grepseed.ilo.gameElements.cuadtree.generador.GeneradorDeRama.__interfaces__ = [grepseed.ilo.gameElements.cuadtree.generador.GeneradorDeCuadTree];
grepseed.ilo.gameElements.cuadtree.generador.GeneradorDeRama.prototype = {
	generar: function(id,cantHojas,posicion,finder,fuente) {
		return new grepseed.ilo.gameElements.cuadtree.CTRama(id,finder,cantHojas,posicion,fuente);
	}
	,__class__: grepseed.ilo.gameElements.cuadtree.generador.GeneradorDeRama
}
grepseed.ilo.gameElements.cuadtree.nodo = {}
grepseed.ilo.gameElements.cuadtree.nodo.Nodo = function(finders,managerDeNodos,managerDeMementos) {
	grepseed.ilo.gameElements.Boton.call(this,"images/nodoCuadTree.png",new grepseed.ilo.gameElements.boton.AccionAnd([new grepseed.ilo.gameElements.boton.AccionNodo(finders,managerDeNodos),new grepseed.ilo.gameElements.boton.AccionAgregarMemento(this,managerDeMementos)]));
	this._finders = finders;
	var pos = finders[3].getPosicionAbsoluta();
	this.set_x(pos.x - this.getWidth() / 2);
	this.set_y(pos.y - this.getHeight() / 2);
};
$hxClasses["grepseed.ilo.gameElements.cuadtree.nodo.Nodo"] = grepseed.ilo.gameElements.cuadtree.nodo.Nodo;
grepseed.ilo.gameElements.cuadtree.nodo.Nodo.__name__ = ["grepseed","ilo","gameElements","cuadtree","nodo","Nodo"];
grepseed.ilo.gameElements.cuadtree.nodo.Nodo.__super__ = grepseed.ilo.gameElements.Boton;
grepseed.ilo.gameElements.cuadtree.nodo.Nodo.prototype = $extend(grepseed.ilo.gameElements.Boton.prototype,{
	controlarDisponibilidad: function(tiempoDeAnimacion) {
		var aux = this.get_visible();
		this.set_visible(this.isDisponible());
		if(this.get_visible() && !aux) {
			var posVieja = this._finders[3].getPosicionAbsoluta();
			this.set_x(posVieja.x);
			this.set_y(posVieja.y);
			posVieja.x -= this.getWidth() / 2;
			posVieja.y -= this.getHeight() / 2;
			this.set_scaleX(0);
			this.set_scaleY(0);
			motion.Actuate.tween(this,tiempoDeAnimacion,{ scaleX : 1, scaleY : 1, x : posVieja.x, y : posVieja.y},false).ease(motion.easing.Elastic.get_easeIn());
		}
	}
	,isDisponible: function() {
		return false;
	}
	,__class__: grepseed.ilo.gameElements.cuadtree.nodo.Nodo
});
grepseed.ilo.gameElements.cuadtree.nodo.NodoCuadTree = function(finders,managerDeNodos,managerDeMementos) {
	grepseed.ilo.gameElements.cuadtree.nodo.Nodo.call(this,finders,managerDeNodos,managerDeMementos);
};
$hxClasses["grepseed.ilo.gameElements.cuadtree.nodo.NodoCuadTree"] = grepseed.ilo.gameElements.cuadtree.nodo.NodoCuadTree;
grepseed.ilo.gameElements.cuadtree.nodo.NodoCuadTree.__name__ = ["grepseed","ilo","gameElements","cuadtree","nodo","NodoCuadTree"];
grepseed.ilo.gameElements.cuadtree.nodo.NodoCuadTree.__super__ = grepseed.ilo.gameElements.cuadtree.nodo.Nodo;
grepseed.ilo.gameElements.cuadtree.nodo.NodoCuadTree.prototype = $extend(grepseed.ilo.gameElements.cuadtree.nodo.Nodo.prototype,{
	isDisponible: function() {
		return !this._finders[0].getCTPadre().isHoja();
	}
	,__class__: grepseed.ilo.gameElements.cuadtree.nodo.NodoCuadTree
});
grepseed.ilo.gameElements.cuadtree.nodo.NodoExtra = function(finders,managerDeNodos,managerDeMementos) {
	grepseed.ilo.gameElements.cuadtree.nodo.Nodo.call(this,finders,managerDeNodos,managerDeMementos);
};
$hxClasses["grepseed.ilo.gameElements.cuadtree.nodo.NodoExtra"] = grepseed.ilo.gameElements.cuadtree.nodo.NodoExtra;
grepseed.ilo.gameElements.cuadtree.nodo.NodoExtra.__name__ = ["grepseed","ilo","gameElements","cuadtree","nodo","NodoExtra"];
grepseed.ilo.gameElements.cuadtree.nodo.NodoExtra.__super__ = grepseed.ilo.gameElements.cuadtree.nodo.Nodo;
grepseed.ilo.gameElements.cuadtree.nodo.NodoExtra.prototype = $extend(grepseed.ilo.gameElements.cuadtree.nodo.Nodo.prototype,{
	isDisponible: function() {
		return this._finders[0].getHoja() != this._finders[1].getHoja() && this._finders[0].getHoja() != this._finders[2].getHoja() && this._finders[1].getHoja() != this._finders[3].getHoja() && this._finders[2].getHoja() != this._finders[3].getHoja();
	}
	,__class__: grepseed.ilo.gameElements.cuadtree.nodo.NodoExtra
});
grepseed.ilo.gameElements.scroll = {}
grepseed.ilo.gameElements.scroll.Scroll = function(anchoScroll) {
	grepseed.ilo.gameElements.GameElement.call(this);
	this._anchoScroll = anchoScroll;
	this._anclas = new Array();
};
$hxClasses["grepseed.ilo.gameElements.scroll.Scroll"] = grepseed.ilo.gameElements.scroll.Scroll;
grepseed.ilo.gameElements.scroll.Scroll.__name__ = ["grepseed","ilo","gameElements","scroll","Scroll"];
grepseed.ilo.gameElements.scroll.Scroll.__super__ = grepseed.ilo.gameElements.GameElement;
grepseed.ilo.gameElements.scroll.Scroll.prototype = $extend(grepseed.ilo.gameElements.GameElement.prototype,{
	updateLogic: function(time) {
		grepseed.ilo.gameElements.GameElement.prototype.updateLogic.call(this,time);
		this.aplicarAlpha();
		this.set_x((this.get_x() + this._xFinal) / 2);
	}
	,moverHastaElAncla: function() {
		this._xFinal = this._xInicial - this.getAnclaMasCercana();
	}
	,mover: function(vectorX,vectorY) {
		if(Math.abs(vectorX) < grepseed.ilo.gameElements.scroll.Scroll._MOVIMIENTO_MAX) this._xFinal += vectorX;
	}
	,agregarAncla: function(ancla) {
		this._anclas.push(ancla);
	}
	,setPosicionInicial: function() {
		this._xInicial = this.get_x();
		this._xFinal = this.get_x();
		this._anchoPanel = this.getWidth();
		this.moverHastaElAncla();
	}
	,aplicarAlpha: function() {
		var o;
		var _g1 = 0, _g = this.nmeChildren.length;
		while(_g1 < _g) {
			var i = _g1++;
			o = this.getChildAt(i);
			o.alpha = 1 - Math.min(1,Math.abs((o.get_width() + 2 * (this.get_x() - this._xInicial + o.get_x())) / this._anchoScroll - 1));
			o.set_visible(o.alpha > 0.2);
			if(o.alpha > 0.6) o.alpha = 1;
		}
	}
	,getAnclaMasCercana: function() {
		var i = 0;
		var pos = this._xInicial - this._xFinal;
		while(this._anclas[i] < pos && i < this._anclas.length - 1) i++;
		if(i > 0 && this._anclas[i] - pos > 0 && this._anclas[i] - pos > pos - this._anclas[i - 1]) i--;
		return this._anclas[i];
	}
	,__class__: grepseed.ilo.gameElements.scroll.Scroll
});
grepseed.ilo.gameElements.scroll.ScrollBotonera = function(managerDeNodos,managerDeClicks,managerDeMementos) {
	grepseed.ilo.gameElements.scroll.Scroll.call(this,grepseed.ilo.gameElements.scroll.ScrollBotonera._ANCHO);
	this.crearBotones(managerDeNodos,managerDeClicks,managerDeMementos);
};
$hxClasses["grepseed.ilo.gameElements.scroll.ScrollBotonera"] = grepseed.ilo.gameElements.scroll.ScrollBotonera;
grepseed.ilo.gameElements.scroll.ScrollBotonera.__name__ = ["grepseed","ilo","gameElements","scroll","ScrollBotonera"];
grepseed.ilo.gameElements.scroll.ScrollBotonera.__super__ = grepseed.ilo.gameElements.scroll.Scroll;
grepseed.ilo.gameElements.scroll.ScrollBotonera.prototype = $extend(grepseed.ilo.gameElements.scroll.Scroll.prototype,{
	clickRandom: function() {
		this._botones[Math.floor(Math.random() * this._botones.length)].click();
	}
	,crearBotones: function(managerDeNodos,managerDeClicks,managerDeMementos) {
		this._botones = new Array();
		var aux;
		var cantidad = Math.floor(grepseed.ilo.gameElements.boton.AccionCambiarAccionNodo.GetCantidadDeRotaciones());
		var _g = 0;
		while(_g < cantidad) {
			var id = _g++;
			aux = new grepseed.ilo.gameElements.Boton("images/accion" + id + ".png",new grepseed.ilo.gameElements.boton.AccionCambiarAccionNodo(id,managerDeNodos,managerDeMementos));
			this._botones.push(aux);
			managerDeClicks.agregar(aux);
			this.addChild(aux);
			aux.set_scaleX(aux.set_scaleY(grepseed.ilo.gameElements.scroll.ScrollBotonera._ESCALA));
			aux.set_x(Math.floor(id / 2) * aux.getWidth() * grepseed.ilo.gameElements.scroll.ScrollBotonera._MARGEN);
			aux.set_y(id % 2 * aux.getHeight() * grepseed.ilo.gameElements.scroll.ScrollBotonera._MARGEN);
			if(id % 2 == 0 && id < cantidad - 2) this.agregarAncla(aux.get_x() - aux.getWidth());
		}
	}
	,__class__: grepseed.ilo.gameElements.scroll.ScrollBotonera
});
grepseed.ilo.gameElements.scroll.ScrollNulo = function() {
	grepseed.ilo.gameElements.scroll.Scroll.call(this,0);
};
$hxClasses["grepseed.ilo.gameElements.scroll.ScrollNulo"] = grepseed.ilo.gameElements.scroll.ScrollNulo;
grepseed.ilo.gameElements.scroll.ScrollNulo.__name__ = ["grepseed","ilo","gameElements","scroll","ScrollNulo"];
grepseed.ilo.gameElements.scroll.ScrollNulo.__super__ = grepseed.ilo.gameElements.scroll.Scroll;
grepseed.ilo.gameElements.scroll.ScrollNulo.prototype = $extend(grepseed.ilo.gameElements.scroll.Scroll.prototype,{
	__class__: grepseed.ilo.gameElements.scroll.ScrollNulo
});
grepseed.ilo.memento = {}
grepseed.ilo.memento.ManagerDeMementos = function(managerDeNodos) {
	this._memento = new grepseed.ilo.memento.MementoNulo();
	this._managerDeNodos = managerDeNodos;
};
$hxClasses["grepseed.ilo.memento.ManagerDeMementos"] = grepseed.ilo.memento.ManagerDeMementos;
grepseed.ilo.memento.ManagerDeMementos.__name__ = ["grepseed","ilo","memento","ManagerDeMementos"];
grepseed.ilo.memento.ManagerDeMementos.prototype = {
	deshacer: function() {
		if(!this._managerDeNodos.isBloqueado()) {
			this._memento.deshacer();
			this._memento = this._memento.getAnterior().getAnterior();
		}
	}
	,hacer: function(boton) {
		this._memento = new grepseed.ilo.memento.MementoConcreto(this._memento,this._proximaAccion,boton);
	}
	,setProximaAccion: function(accion) {
		this._proximaAccion = accion;
	}
	,__class__: grepseed.ilo.memento.ManagerDeMementos
}
grepseed.ilo.memento.Memento = function() { }
$hxClasses["grepseed.ilo.memento.Memento"] = grepseed.ilo.memento.Memento;
grepseed.ilo.memento.Memento.__name__ = ["grepseed","ilo","memento","Memento"];
grepseed.ilo.memento.Memento.prototype = {
	__class__: grepseed.ilo.memento.Memento
}
grepseed.ilo.memento.MementoConcreto = function(anterior,accion,boton) {
	this._anterior = anterior;
	this._accion = accion;
	this._boton = boton;
};
$hxClasses["grepseed.ilo.memento.MementoConcreto"] = grepseed.ilo.memento.MementoConcreto;
grepseed.ilo.memento.MementoConcreto.__name__ = ["grepseed","ilo","memento","MementoConcreto"];
grepseed.ilo.memento.MementoConcreto.__interfaces__ = [grepseed.ilo.memento.Memento];
grepseed.ilo.memento.MementoConcreto.prototype = {
	getAnterior: function() {
		return this._anterior;
	}
	,deshacer: function() {
		this._accion.deshacer();
		this._boton.click();
	}
	,__class__: grepseed.ilo.memento.MementoConcreto
}
grepseed.ilo.memento.MementoNulo = function() {
};
$hxClasses["grepseed.ilo.memento.MementoNulo"] = grepseed.ilo.memento.MementoNulo;
grepseed.ilo.memento.MementoNulo.__name__ = ["grepseed","ilo","memento","MementoNulo"];
grepseed.ilo.memento.MementoNulo.__interfaces__ = [grepseed.ilo.memento.Memento];
grepseed.ilo.memento.MementoNulo.prototype = {
	getAnterior: function() {
		return this;
	}
	,deshacer: function() {
	}
	,__class__: grepseed.ilo.memento.MementoNulo
}
grepseed.ilo.posiciones = {}
grepseed.ilo.posiciones.Posiciones1920x1080 = function() {
	this._posiciones = new haxe.ds.StringMap();
	this._posiciones.set("gp_botonera",new flash.geom.Point(1200,650));
	this._posiciones.set("gp_boton_imagenes",new flash.geom.Point(1625,100));
	this._posiciones.set("gp_boton_deshacer",new flash.geom.Point(1625,340));
	this._posiciones.set("gp_accionSeleccionada",new flash.geom.Point(1280,250));
};
$hxClasses["grepseed.ilo.posiciones.Posiciones1920x1080"] = grepseed.ilo.posiciones.Posiciones1920x1080;
grepseed.ilo.posiciones.Posiciones1920x1080.__name__ = ["grepseed","ilo","posiciones","Posiciones1920x1080"];
grepseed.ilo.posiciones.Posiciones1920x1080.getInstancia = function() {
	if(grepseed.ilo.posiciones.Posiciones1920x1080._INSTANCIA == null) grepseed.ilo.posiciones.Posiciones1920x1080._INSTANCIA = new grepseed.ilo.posiciones.Posiciones1920x1080();
	return grepseed.ilo.posiciones.Posiciones1920x1080._INSTANCIA;
}
grepseed.ilo.posiciones.Posiciones1920x1080.prototype = {
	posicionar: function(id,objeto) {
		var posicion = this._posiciones.get(id);
		objeto.set_x(posicion.x);
		objeto.set_y(posicion.y);
	}
	,__class__: grepseed.ilo.posiciones.Posiciones1920x1080
}
grepseed.ilo.screens = {}
grepseed.ilo.screens.Screen = function(sm) {
	grepseed.ilo.gameElements.GameElement.call(this);
	this._screenManager = sm;
};
$hxClasses["grepseed.ilo.screens.Screen"] = grepseed.ilo.screens.Screen;
grepseed.ilo.screens.Screen.__name__ = ["grepseed","ilo","screens","Screen"];
grepseed.ilo.screens.Screen.__super__ = grepseed.ilo.gameElements.GameElement;
grepseed.ilo.screens.Screen.prototype = $extend(grepseed.ilo.gameElements.GameElement.prototype,{
	...
	,__class__: grepseed.ilo.screens.Screen
});
grepseed.ilo.screens.GamePlayScreen = function(screenManager,managerDeClicks) {
	grepseed.ilo.screens.Screen.call(this,screenManager);
	this._fondo = new grepseed.ilo.gameElements.Image("images/fondo.jpg");
	this._accionActual = new grepseed.ilo.gameElements.Image("images/accion0.png");
	grepseed.ilo.posiciones.Posiciones1920x1080.getInstancia().posicionar("gp_accionSeleccionada",this._accionActual);
	var managerDeNodos = new grepseed.ilo.ManagerDeNodos(managerDeClicks,this._accionActual);
	var managerDeMementos = new grepseed.ilo.memento.ManagerDeMementos(managerDeNodos);
	this.crearBotonera(managerDeNodos,managerDeClicks,managerDeMementos);
	this.crearTablero(managerDeNodos,managerDeMementos);
};
$hxClasses["grepseed.ilo.screens.GamePlayScreen"] = grepseed.ilo.screens.GamePlayScreen;
grepseed.ilo.screens.GamePlayScreen.__name__ = ["grepseed","ilo","screens","GamePlayScreen"];
grepseed.ilo.screens.GamePlayScreen.__super__ = grepseed.ilo.screens.Screen;
grepseed.ilo.screens.GamePlayScreen.prototype = $extend(grepseed.ilo.screens.Screen.prototype,{
	end: function(onComplete) {
		this.removeChild(this._fondo);
		this.removeChild(this._tablero);
		this.borrarHijoCompleto(this._scroll);
		this.removeChild(this._botonDeshacer);
		this.removeChild(this._botonImagenes);
		this.removeChild(this._accionActual);
		this.removeChild(this._puzzle);
		this.removeChild(this._nodos);
		grepseed.ilo.screens.Screen.prototype.end.call(this,onComplete);
	}
	,init: function(time) {
		grepseed.ilo.screens.Screen.prototype.init.call(this,time);
		this.addChild(this._fondo);
		this.addChild(this._tablero);
		this.agregarHijoCompleto(this._scroll);
		this.addChild(this._botonDeshacer);
		this.addChild(this._botonImagenes);
		this.addChild(this._accionActual);
		this.addChild(this._puzzle);
		this.addChild(this._nodos);
	}
	,crearTablero: function(managerDeNodos,managerDeMementos) {
		this._tablero = new grepseed.ilo.gameElements.Image("images/tablero.jpg");
		this._tablero.set_x(this._tablero.set_y((this._fondo.getHeight() - this._tablero.getHeight()) / 2));
		this._nodos = new flash.display.Sprite();
		var filas = Math.floor(Math.pow(2,grepseed.ilo.screens.GamePlayScreen._NIVELES));
		var fuente = new grepseed.ilo.gameElements.cuadtree.FuenteCT("images/ejemplo.jpg",filas,filas);
		var margen = (this._tablero.getHeight() - fuente.getAlto() * filas) / 2 + this._tablero.get_y();
		this._puzzle = new grepseed.ilo.gameElements.cuadtree.CTRama(0,null,Math.floor(Math.pow(filas,2)),new flash.geom.Point(margen,margen),fuente);
		this._puzzle.crearNodos(this._nodos,managerDeNodos,managerDeMementos);
		managerDeNodos.mezclar(grepseed.ilo.screens.GamePlayScreen._MEZCLAS,this._scroll);
	}
	,crearBotonera: function(managerDeNodos,managerDeClicks,managerDeMementos) {
		this._botonDeshacer = new grepseed.ilo.gameElements.Boton("images/botonDeshacer.png",new grepseed.ilo.gameElements.boton.AccionDeshacer(managerDeMementos));
		grepseed.ilo.posiciones.Posiciones1920x1080.getInstancia().posicionar("gp_boton_deshacer",this._botonDeshacer);
		managerDeClicks.agregar(this._botonDeshacer);
		this._botonImagenes = new grepseed.ilo.gameElements.Boton("images/botonImagenes.png",new grepseed.ilo.gameElements.boton.AccionNula());
		grepseed.ilo.posiciones.Posiciones1920x1080.getInstancia().posicionar("gp_boton_imagenes",this._botonImagenes);
		managerDeClicks.agregar(this._botonImagenes);
		this._scroll = new grepseed.ilo.gameElements.scroll.ScrollBotonera(managerDeNodos,managerDeClicks,managerDeMementos);
		managerDeClicks.setScroll(this._scroll);
		grepseed.ilo.posiciones.Posiciones1920x1080.getInstancia().posicionar("gp_botonera",this._scroll);
		this._scroll.setPosicionInicial();
	}
	,__class__: grepseed.ilo.screens.GamePlayScreen
});
grepseed.ilo.screens.MenuScreen = function(sm,cm) {
	grepseed.ilo.screens.Screen.call(this,sm);
	this._botonJugar = new grepseed.ilo.gameElements.Boton("images/boton_jugar.png",new grepseed.ilo.gameElements.boton.AccionCambiarPantalla("juego",sm));
	this._botonJugar.set_x(this._botonJugar.getWidth() * 3);
	this._botonJugar.set_y(this._botonJugar.getHeight() * 3);
	cm.agregar(this._botonJugar);
};
$hxClasses["grepseed.ilo.screens.MenuScreen"] = grepseed.ilo.screens.MenuScreen;
grepseed.ilo.screens.MenuScreen.__name__ = ["grepseed","ilo","screens","MenuScreen"];
grepseed.ilo.screens.MenuScreen.__super__ = grepseed.ilo.screens.Screen;
grepseed.ilo.screens.MenuScreen.prototype = $extend(grepseed.ilo.screens.Screen.prototype,{
	end: function(onComplete) {
		this.removeChild(this._botonJugar);
		grepseed.ilo.screens.Screen.prototype.end.call(this,onComplete);
	}
	,init: function(time) {
		this.addChild(this._botonJugar);
	}
	,__class__: grepseed.ilo.screens.MenuScreen
});
grepseed.ilo.screens.ScreenManager = function() {
	flash.display.Sprite.call(this);
	this._screens = new haxe.ds.StringMap();
	this._screenTimes = new haxe.ds.ObjectMap();
};
$hxClasses["grepseed.ilo.screens.ScreenManager"] = grepseed.ilo.screens.ScreenManager;
grepseed.ilo.screens.ScreenManager.__name__ = ["grepseed","ilo","screens","ScreenManager"];
grepseed.ilo.screens.ScreenManager.__super__ = flash.display.Sprite;
grepseed.ilo.screens.ScreenManager.prototype = $extend(flash.display.Sprite.prototype,{
	updateLogic: function(time) {
		time -= this._otherScreensTime;
		this._currentScreen.updateLogic(time);
		this._screenTimes.set(this._currentScreen,time);
	}
	,suscribeScreen: function(name,screen) {
		this._screens.set(name,screen);
		this._screenTimes.set(screen,0);
		if(this._currentScreen == null) this.setCurrentScreen(screen);
	}
	,actualizarTiempos: function() {
		this._otherScreensTime = 0;
		var $it0 = ((function(_e) {
			return function() {
				return _e.iterator();
			};
		...
		while( $it0.hasNext() ) {
			var time = $it0.next();
			this._otherScreensTime += time;
		}
		this._otherScreensTime -= this._screenTimes.h[this._currentScreen.__id__];
	}
	,setCurrentScreen: function(screen) {
		this._currentScreen = screen;
		this.addChild(this._currentScreen);
		this.actualizarTiempos();
		this._currentScreen.init(this._screenTimes.h[this._currentScreen.__id__]);
		flash.Lib.get_current().get_stage().set_focus(this._currentScreen);
	}
	,switchScene: function(name) {
		var _g = this;
		var escene = this._screens.get(name);
		if(this._currentScreen != null) this._currentScreen.end(function() {
			_g.removeChild(_g._currentScreen);
			_g.setCurrentScreen(escene);
		}); else this.setCurrentScreen(escene);
	}
	,__class__: grepseed.ilo.screens.ScreenManager
});
...
nme.AssetData.initialize = function() {
	if(!nme.AssetData.initialized) {
		nme.AssetData.path.set("images/accion0.png","images/accion0.png");
		var value = Reflect.field(openfl.AssetType,"image".toUpperCase());
		nme.AssetData.type.set("images/accion0.png",value);
		nme.AssetData.path.set("images/accion1.png","images/accion1.png");
		var value = Reflect.field(openfl.AssetType,"image".toUpperCase());
		nme.AssetData.type.set("images/accion1.png",value);
		nme.AssetData.path.set("images/accion10.png","images/accion10.png");
		var value = Reflect.field(openfl.AssetType,"image".toUpperCase());
		nme.AssetData.type.set("images/accion10.png",value);
		nme.AssetData.path.set("images/accion11.png","images/accion11.png");
		var value = Reflect.field(openfl.AssetType,"image".toUpperCase());
		nme.AssetData.type.set("images/accion11.png",value);
		nme.AssetData.path.set("images/accion12.png","images/accion12.png");
		var value = Reflect.field(openfl.AssetType,"image".toUpperCase());
		nme.AssetData.type.set("images/accion12.png",value);
		nme.AssetData.path.set("images/accion13.png","images/accion13.png");
		var value = Reflect.field(openfl.AssetType,"image".toUpperCase());
		nme.AssetData.type.set("images/accion13.png",value);
		nme.AssetData.path.set("images/accion14.png","images/accion14.png");
		var value = Reflect.field(openfl.AssetType,"image".toUpperCase());
		nme.AssetData.type.set("images/accion14.png",value);
		nme.AssetData.path.set("images/accion15.png","images/accion15.png");
		var value = Reflect.field(openfl.AssetType,"image".toUpperCase());
		nme.AssetData.type.set("images/accion15.png",value);
		nme.AssetData.path.set("images/accion16.png","images/accion16.png");
		var value = Reflect.field(openfl.AssetType,"image".toUpperCase());
		nme.AssetData.type.set("images/accion16.png",value);
		nme.AssetData.path.set("images/accion17.png","images/accion17.png");
		var value = Reflect.field(openfl.AssetType,"image".toUpperCase());
		nme.AssetData.type.set("images/accion17.png",value);
		nme.AssetData.path.set("images/accion18.png","images/accion18.png");
		var value = Reflect.field(openfl.AssetType,"image".toUpperCase());
		nme.AssetData.type.set("images/accion18.png",value);
		nme.AssetData.path.set("images/accion19.png","images/accion19.png");
		var value = Reflect.field(openfl.AssetType,"image".toUpperCase());
		nme.AssetData.type.set("images/accion19.png",value);
		nme.AssetData.path.set("images/accion2.png","images/accion2.png");
		var value = Reflect.field(openfl.AssetType,"image".toUpperCase());
		nme.AssetData.type.set("images/accion2.png",value);
		nme.AssetData.path.set("images/accion3.png","images/accion3.png");
		var value = Reflect.field(openfl.AssetType,"image".toUpperCase());
		nme.AssetData.type.set("images/accion3.png",value);
		nme.AssetData.path.set("images/accion4.png","images/accion4.png");
		var value = Reflect.field(openfl.AssetType,"image".toUpperCase());
		nme.AssetData.type.set("images/accion4.png",value);
		nme.AssetData.path.set("images/accion5.png","images/accion5.png");
		var value = Reflect.field(openfl.AssetType,"image".toUpperCase());
		nme.AssetData.type.set("images/accion5.png",value);
		nme.AssetData.path.set("images/accion6.png","images/accion6.png");
		var value = Reflect.field(openfl.AssetType,"image".toUpperCase());
		nme.AssetData.type.set("images/accion6.png",value);
		nme.AssetData.path.set("images/accion7.png","images/accion7.png");
		var value = Reflect.field(openfl.AssetType,"image".toUpperCase());
		nme.AssetData.type.set("images/accion7.png",value);
		nme.AssetData.path.set("images/accion8.png","images/accion8.png");
		var value = Reflect.field(openfl.AssetType,"image".toUpperCase());
		nme.AssetData.type.set("images/accion8.png",value);
		nme.AssetData.path.set("images/accion9.png","images/accion9.png");
		var value = Reflect.field(openfl.AssetType,"image".toUpperCase());
		nme.AssetData.type.set("images/accion9.png",value);
		nme.AssetData.path.set("images/botonDeshacer.png","images/botonDeshacer.png");
		var value = Reflect.field(openfl.AssetType,"image".toUpperCase());
		nme.AssetData.type.set("images/botonDeshacer.png",value);
		nme.AssetData.path.set("images/botonImagenes.png","images/botonImagenes.png");
		var value = Reflect.field(openfl.AssetType,"image".toUpperCase());
		nme.AssetData.type.set("images/botonImagenes.png",value);
		nme.AssetData.path.set("images/boton_jugar.png","images/boton_jugar.png");
		var value = Reflect.field(openfl.AssetType,"image".toUpperCase());
		nme.AssetData.type.set("images/boton_jugar.png",value);
		nme.AssetData.path.set("images/ejemplo.jpg","images/ejemplo.jpg");
		var value = Reflect.field(openfl.AssetType,"image".toUpperCase());
		nme.AssetData.type.set("images/ejemplo.jpg",value);
		nme.AssetData.path.set("images/fondo.jpg","images/fondo.jpg");
		var value = Reflect.field(openfl.AssetType,"image".toUpperCase());
		nme.AssetData.type.set("images/fondo.jpg",value);
		nme.AssetData.path.set("images/nodoCuadTree.png","images/nodoCuadTree.png");
		var value = Reflect.field(openfl.AssetType,"image".toUpperCase());
		nme.AssetData.type.set("images/nodoCuadTree.png",value);
		nme.AssetData.path.set("images/tablero.jpg","images/tablero.jpg");
		var value = Reflect.field(openfl.AssetType,"image".toUpperCase());
		nme.AssetData.type.set("images/tablero.jpg",value);
...
grepseed.ilo.Main._ANCHO_PANTALLA = 1925;
grepseed.ilo.Main._ALTO_PANTALLA = 1080;
...
grepseed.ilo.ManagerDeNodos._TIEMPO_DE_ANIMACION = 0.9;
grepseed.ilo.gameElements.boton.AccionCambiarAccionNodo._ROTACIONES = [[1],[2,3,2],[2],[1,3,1],[3],[1,2,1],[1,3,1,2],[2,3,2,1],[1,2,1,3],[1,3,2,1],[3,2],[1,2],[1,3],[1,2,3,1],[2,3],[2,1],[3,1],[1,3,2],[2,3,1],[]];
grepseed.ilo.gameElements.boton.AccionCambiarAccionNodo._INVERSAS = [0,1,2,3,4,5,6,7,8,13,14,15,16,9,10,11,12,18,17,19];
grepseed.ilo.gameElements.scroll.Scroll._MOVIMIENTO_MAX = 90;
grepseed.ilo.gameElements.scroll.ScrollBotonera._ANCHO = 600;
grepseed.ilo.gameElements.scroll.ScrollBotonera._MARGEN = 1.4;
grepseed.ilo.gameElements.scroll.ScrollBotonera._ESCALA = 0.8;
grepseed.ilo.screens.GamePlayScreen._NIVELES = 3;
grepseed.ilo.screens.GamePlayScreen._MEZCLAS = 8;
